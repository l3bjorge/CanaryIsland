...
public class FavouritePresenter
    extends GenericPresenter
        <Favourite.PresenterToView, Favourite.PresenterToModel, Favourite.ModelToPresenter, FavouriteModel>
    implements Favourite.ViewToPresenter, Favourite.ModelToPresenter, Favourite.CanaryIslandTo, Favourite.ToCanaryIsland {
   ...
   */
  @Override
  public void onCreate(Favourite.PresenterToView view) {
    super.onCreate(FavouriteModel.class, this);
    setView(view);
   ...
   */
  @Override
  public void onResume(Favourite.PresenterToView view) {
    setView(view);
